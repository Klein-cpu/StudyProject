...
void AInteractiveCameraActor::OnEndOverlap(UPrimitiveComponent* OverlappedComponent, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex)
{
	...
	FViewTargetTransitionParams TransitionToPlayerParams;
	TransitionToPlayerParams.BlendTime = TransitionToCameraTime;
	TransitionToPlayerParams.bLockOutgoing = true;
	PlayerController->SetViewTarget(Pawn, TransitionToPlayerParams);
}
